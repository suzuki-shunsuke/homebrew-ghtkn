...
cask "ghtkn" do
  ...
  on_macos do
    on_intel do
      sha256 "147496f882439f6affa1e493c08a57f90ed7d28d499c0a6c169c907f33a4448e"
      url "https://github.com/suzuki-shunsuke/ghtkn/releases/download/v#{version}/ghtkn_darwin_amd64.tar.gz"
    end
    on_arm do
      sha256 "7463d826f7b834e696d4132a022106d35bbc52182d06fd9eceb72e64dcab888f"
  ...
  on_linux do
    on_intel do
      sha256 "2d47f2d649c5c1103ed21f3bcaf38684daf65b6f4aed7d480d65299f5beb4b2e"
      url "https://github.com/suzuki-shunsuke/ghtkn/releases/download/v#{version}/ghtkn_linux_amd64.tar.gz"
    end
    on_arm do
      sha256 "3c75ede775eb05d3b0943ce13c26f90415b46999ff5880f339cbfbca1dcd3770"
